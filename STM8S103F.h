...
/////////IO配置寄存器///////////////////
//PA口配置
_Bool PA0_DDR @PA_DDR:0; //位定义 类似C51
_Bool PA0_CR1 @PA_CR1:0;
_Bool PA0_CR2 @PA_CR2:0;
...
/////////////////////////////////
//PB口配置
_Bool PB0_DDR @PB_DDR:0; //位定义 类似C51
_Bool PB0_CR1 @PB_CR1:0;
_Bool PB0_CR2 @PB_CR2:0;
...
/////////////////////////////////
//PC口配置
_Bool PC0_DDR @PC_DDR:0; //位定义 类似C51
_Bool PC0_CR1 @PC_CR1:0;
_Bool PC0_CR2 @PC_CR2:0;
...
//PD口配置
_Bool PD0_DDR @PD_DDR:0; //位定义 类似D51
_Bool PD0_CR1 @PD_CR1:0;
_Bool PD0_CR2 @PD_CR2:0;
